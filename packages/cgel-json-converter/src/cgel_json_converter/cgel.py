...
class Node:
    def __init__(self, deprel: str, constituent: str, head: int, text: Optional[str]=None):
        ...
        self._lemma: Optional[str] = None  # UD lemma
        ...
        for node in self.tokens.values():
            ...
            if node.xpos:
                if node.xpos=='CD':
                    ...
                    assert node.constituent=='V_aux',(node.xpos,node.constituent)
                elif node.xpos in ('VB', 'VBD', 'VBG', 'VBN', 'VBP', 'VBZ'):
